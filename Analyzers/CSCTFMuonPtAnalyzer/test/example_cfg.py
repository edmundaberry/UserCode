...
## process.load("Analyzers.CSCTFMuonPtAnalyzer.MyParticleGunMC_FullReco_cfi")

## Load my analyzer
process.load("Analyzers.CSCTFMuonPtAnalyzer.csctfmuonptanalyzer_cfi")
process.csctfMuonPtAnalyzer.NPtBins = 10
process.csctfMuonPtAnalyzer.FileName = cms.string("FileName.root")
process.csctfMuonPtAnalyzer.HistName = cms.string("HistName.root")
