...
def switchToSimGtDigis(process):
  ...
  process.hltL1GtObjectMap.GmtInputTag = Config.InputTag( 'simGmtDigis','','L1ReRun' )
  process.hltL1GtObjectMap.GctInputTag = Config.InputTag( 'simGctDigis','','L1ReRun' )
  process.hltL1extraParticles.muonSource = Config.InputTag( 'simGmtDigis','','L1ReRun' )
  process.hltL1extraParticles.isolatedEmSource = Config.InputTag( 'simGctDigis','isoEm' )
  process.hltL1extraParticles.nonIsolatedEmSource = Config.InputTag( 'simGctDigis','nonIsoEm','L1ReRun' )
  process.hltL1extraParticles.centralJetSource = Config.InputTag( 'simGctDigis','cenJets','L1ReRun' )
  process.hltL1extraParticles.forwardJetSource = Config.InputTag( 'simGctDigis','forJets','L1ReRun' )
  process.hltL1extraParticles.tauJetSource = Config.InputTag( 'simGctDigis','tauJets','L1ReRun' )
  process.hltL1extraParticles.etTotalSource = Config.InputTag( 'simGctDigis','','L1ReRun' )
  process.hltL1extraParticles.etHadSource = Config.InputTag( 'simGctDigis','','L1ReRun' )
  process.hltL1extraParticles.etMissSource = Config.InputTag( 'simGctDigis','','L1ReRun' )
  process.hltL2MuonSeeds.GMTReadoutCollection = Config.InputTag( 'simGmtDigis','','L1ReRun' )
